    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int j = 1;j < 5;j++) {
            Document document = Jsoup
                    //http://www.topit.me/tag/%E6%80%A7%E6%84%9F?p=3
                    .connect("http://www.topit.me/tag/%E6%80%A7%E6%84%9F?p="+j)
                    .cookie("is_click","1")
            ...
            for(int i = 0;i < elements.size();i++) {
                ...
                if(response.getStatusLine().getStatusCode() == 200) {
                    ...
                    FileOutputStream outputStream = new FileOutputStream("E://mmpicture"+imageName);
